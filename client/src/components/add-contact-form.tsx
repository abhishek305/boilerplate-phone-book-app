...
import { InsertContact, contactFormSchema } from "@shared/schema";
...
export function AddContactForm({ isOpen, onClose, onSubmit }: AddContactFormProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
        <DialogHeader>
          <DialogTitle className="text-lg font-semibold text-gray-900 dark:text-gray-100">Add New Contact</DialogTitle>
